...
st.markdown("""
    ...
    .stPopover > button { border: none !important; background-color: transparent !important; color: #F39800 !important; }
...
if st.button("✨ 點我得知符合機率"):
    ...
    if prob >= 0.6:
        ...
        st.warning("🟡 目前處於門檻邊緣，建議諮詢 **UIA好厝邊** 服務安排。")
    else:
        st.info("⚪ 目前狀況良好。預防重於治療！")
